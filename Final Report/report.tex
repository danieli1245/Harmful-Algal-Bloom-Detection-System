...
Our project set out to build a smarter and scalable approach using satellite data and deep learning, heavily based on HABNet \cite{b1}. The aim was to design a system that can predict toxic bloom events from space quickly, accurately, and in a way that's easy for people to use. This addresses a critical gap where traditional methods provide results too late for effective intervention, while advanced research systems like HABNet remain inaccessible to most potential users. It fits into a larger effort to apply AI to real-world environmental problems, where timely action can help prevent serious harm.
